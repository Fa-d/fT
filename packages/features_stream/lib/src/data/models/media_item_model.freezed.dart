...
mixin _$MediaItemModel {
  ...
  Map<String, String> get qualityOptions => throw _privateConstructorUsedError;
...
class _$MediaItemModelImpl extends _MediaItemModel {
  ...
  @override
  Map<String, String> get qualityOptions {
    if (_qualityOptions is EqualUnmodifiableMapView) return _qualityOptions;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_qualityOptions);
  }
  ...
  @override
  String toString() {
    return 'MediaItemModel(id: $id, title: $title, description: $description, thumbnailUrl: $thumbnailUrl, durationInSeconds: $durationInSeconds, streamUrl: $streamUrl, type: $type, qualityOptions: $qualityOptions, publishedAt: $publishedAt, author: $author, viewCount: $viewCount)';
  }
